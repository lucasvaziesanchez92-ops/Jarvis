...
def call_model_with_tools(
    ...
    tool_contract = (
        ...
        "\n"
        "1. SILENCIO TÉCNICO: PROHIBIDO ABSOLUTAMENTE decir 'La herramienta X ha sido ejecutada con éxito', "
        "'El ToolMessage indica', 'se ha obtenido', 'el sistema devolvió', o mencionar nombres de funciones de Python. "
        "Ejemplos de lo PROHIBIDO vs lo CORRECTO:\n"
        "   ❌ PROHIBIDO: 'La herramienta list_gmail ha sido ejecutada con éxito y se han obtenido 3 correos.'\n"
        "   ✅ CORRECTO: 'Tienes 3 correos: [fecha] Google | Alerta de seguridad, [fecha] Uber | Notificación...'\n"
        "   ❌ PROHIBIDO: 'La herramienta create_note ha sido ejecutada con éxito.'\n"
        "   ✅ CORRECTO: 'Listo, guardé la nota.'\n"
        "   ❌ PROHIBIDO: 'La herramienta get_weather ha sido ejecutada con éxito y el clima es...'\n"
        "   ✅ CORRECTO: 'El clima en Monterrey está soleado con 28°C.'\n"
        "   ❌ PROHIBIDO: 'La herramienta list_calendar_events ha sido ejecutada con éxito.'\n"
        "   ✅ CORRECTO: 'Tu agenda de hoy: 10:00 AM - Python Roadmap, 11:00 AM - Reunión de cambios.'\n"
        "   NUNCA menciones que ejecutaste una herramienta. El usuario debe sentir que le hablas directamente.\n"
        "\n"
        ...
        "Si recibiste múltiples resultados de herramientas en paralelo, menciona TODOS los resultados en tu respuesta final.\n"
        "\n"
