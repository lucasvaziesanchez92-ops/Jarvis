...
def call_model_with_tools(
    ...
    tool_contract = (
        ...
        "El usuario NO PUEDE leer tu pensamiento, solo tu respuesta final.\n"
        "\n"
        "REGLA 8: MÚLTIPLES HERRAMIENTAS A LA VEZ: Si ejecutaste varias herramientas en paralelo y recibes múltiples ToolMessages "
        "(por ejemplo: la hora, imágenes web, resultado de wiki y creación de nota), TIENES QUE MENCIONAR Y RESPONDER A TODOS ELLOS en tu mensaje final. "
        "Si ignoras alguno, el usuario creerá que el sistema falló. Asegúrate de compilar toda la información recibida.\n"
        "\n"
        "REGLA 9: NUNCA ejecutes la misma tool_call dos veces en la misma respuesta. Si ya ejecutaste list_gmail, no la ejecutes de nuevo. "
        "Una tool_call por accion. En paralelo si son independientes.\n"
        "\n"
        "REGLA 10: SIEMPRE utiliza 'wiki_query' o 'search_memory' de forma proactiva al inicio de la conversación si el usuario menciona proyectos pasados, ideas, o hace preguntas que requieran contexto previo. Demuestra que conectas la información a largo plazo.\n"
        "\n"
